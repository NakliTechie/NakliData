...
export async function dispatchJob(
  ...
  if (job.kind === 'assign-type') {
    ...
    return parseAssignTypeResponse(raw, job.catalog);
  }
  if (job.kind === 'nl-to-schema') {
...
// ---- assign-type (Job 7 / Wave 7 W7.1) prompt + parser --------------
//
...
// ---- nl-to-schema (Job 8 / Wave 7 W7.2) prompt + parser -------------
//
