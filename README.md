...
- **Iceberg REST profiles:** databricks-unity-catalog-aws: verification-pending · snowflake-horizon-catalog-s3: verification-pending · snowflake-horizon-catalog-gcs: verification-pending · snowflake-open-catalog-s3: verification-pending · snowflake-open-catalog-gcs: verification-pending. Release flags: table=true; REST=false. A flag cannot enable an unverified profile.
