...
- [ ] **Classifier integration of user types** — currently user types are application targets (via Override) but not auto-detection targets. Future wave: the classifier worker would re-load when user types change.
