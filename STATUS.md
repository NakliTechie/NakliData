## Last update: 2026-05-18T18:00:00Z
## Current milestone: **AI sidecar wave 2 shipped** — type-disambiguation. "Ask sidecar" button on ambiguous schema columns (≥2 candidates + confidence ∈ [0.5, 0.9) + origin='detector'). One-token answer; chosen typeId applied via the existing `overrideAssignment` (origin='user_override'). DECISIONS 2026-05-18 18:00. Wave 1 (BYOK + explain-query-error) shipped earlier today; Theme 2 + Theme 3 wave 2 + v1.0.0 tag landed yesterday. Next: sidecar wave 3 (define-new-type assist), or pivot to Theme 4 / Theme 1 wave 3 / v1.0 carryover.
## Build status: green — `dist/index.html` 360 KB; `dist/chunks/codemirror.js` 364 KB lazy; `dist/chunks/observable-plot.js` 273 KB lazy; `dist/chunks/cytoscape-graph.js` 436 KB lazy; `dist/chunks/maplibre-map.js` 1.0 MB lazy; `dist/sw.js` 2.7 KB; tsc clean; biome 0 errors / 14 warnings; **114 vitest + 19 Playwright e2e** passing; headless smoke green.
