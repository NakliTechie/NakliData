## Last update: 2026-05-24T12:35:00Z
## Current milestone: **W1.2 README v1.1 refresh + W1.1 v1.1.0 release notes drafted; full release gate green.** README rewritten to cover Theme 2 surfaces (pivot / map / Plot chart types / pie + facet), Theme 3 wave 2 (multi-session, share link, PWA), Theme 4 (column profile / compare tables / override rules / demo mode), AI sidecar (BYOK + three jobs + user types), vendored DuckDB extensions (`?offline=1`); formats list 13 → 15; taxonomy 40 → 41. `plan/v1.1.0-release-notes.md` is the canonical changelog (27 commits since v1.0.0). Two e2e stability fixes landed in the same pass: `save-load.spec.ts` clears IDB between save + reload so the explicit Load doesn't race boot-time auto-restore, and `override-rules.spec.ts` toast wait bumped from 4s → 8s for workers=2 contention headroom. **W1.4 (mirror) deferred** to its own short wave after the tag. Earlier: Wave 1 polish + v1.0 review carryover landed 2026-05-24; Theme 1 wave 3 vendored extensions on 2026-05-23; Theme 4 complete on 2026-05-21; classifier integration of user types on 2026-05-19; AI sidecar arc complete on 2026-05-18; Theme 2 + Theme 3 wave 2 + v1.0.0 tag on 2026-05-17. **Next:** tag `v1.1.0` (ask before pushing) → Wave 2 (Iceberg + S3 precursors + custom-endpoint sidecar + eval harness).
